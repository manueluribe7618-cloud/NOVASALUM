...
from src.ui.layout import render_page_header, render_sidebar
...
def run_application() -> None:
    ...
    company, global_term, request_payment = render_page_header()
    st.write("")
    ...
    if view == "Cartera manual":
        render_manual_portfolio(company, global_term)
